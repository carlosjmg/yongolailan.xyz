...
export const COLLECTIONS: Record<string, Collection> = {
  catalog: {
    ...
    fields: [
      ...
      { name: "accentColor", label: "Accent color", type: "color", help: "This release's main accent. The Buy button gradient starts here." },
      { name: "accentColor2", label: "Accent color 2 (Buy gradient)", type: "color", help: "Pick a second colour from the cover — the Buy button becomes a gradient between the two. Leave empty for a single colour." },
