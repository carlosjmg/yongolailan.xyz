...
export const COLLECTIONS: Record<string, Collection> = {
  catalog: {
    ...
    fields: [
      ...
      { name: "accentColor", label: "Accent color", type: "color", help: "This release's main accent. The Buy button's border gradient starts here." },
      { name: "accentColor2", label: "Accent color 2 (Buy button border)", type: "color", help: "Pick a second colour from the cover — the Buy button's border becomes a gradient between the two. Leave empty for a single-colour border." },
      ...
      { name: "bandcampUrl", label: "Bandcamp link", type: "url", help: "Clicking the song itself (the cover) opens this link directly." },
      { name: "buyUrl", label: "Buy button link", type: "url", help: "Where the “Buy →” button sends people — a store, merch page, or any site you choose. Independent of Bandcamp." },
  ...
  "label-productions": {
    ...
    fields: [
      ...
      { name: "spotifyUrl", label: "Spotify link", type: "url", placeholder: "https://open.spotify.com/track/…", help: "Ignored when a release is linked above." },
      { name: "appleUrl", label: "Apple Music link", type: "url", placeholder: "https://music.apple.com/…", help: "Ignored when a release is linked above." },
