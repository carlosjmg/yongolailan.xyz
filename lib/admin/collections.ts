...
export const COLLECTIONS: Record<string, Collection> = {
  ...
  photos: {
    ...
    fields: [
      ...
      { name: "caption", label: "Caption", type: "text", placeholder: "Live Performance · Press Photo" },
      { name: "title", label: "Alt text / title", type: "text" },
      { name: "category", label: "Category", type: "select", options: ["press", "artist", "logo", "branding"] },
      { name: "published", label: "Visible on site", type: "boolean" },
    ],
  },
